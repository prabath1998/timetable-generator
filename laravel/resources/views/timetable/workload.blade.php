    ...
    <div class="space-y-4">
      ...
      <div class="flex flex-col md:flex-row md:items-end md:justify-between gap-6">
        <div>
          ...
          <p class="text-slate-600 mt-2">Timetable #{{ $id }} · {{ $totalTeachers }} teachers · {{ $weeklySlots }} periods/week capacity</p>
        </div>
      ...
      <div class="bg-white rounded-2xl p-6 shadow-sm border border-slate-200/60">
        <div class="flex items-start justify-between">
          <div>
            ...
            <p class="text-xs text-slate-500 mt-1">{{ $totalAssigned }} / {{ $totalCapacity }} total periods</p>
          </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
      ...
      <div class="bg-white rounded-2xl p-6 shadow-sm border border-slate-200/60">
        <div class="flex items-center justify-between mb-4">
          ...
          <span class="text-xs font-medium text-slate-500 bg-slate-100 px-3 py-1 rounded-full">Periods / {{ $weeklySlots }}</span>
        </div>
          ...
          <table class="min-w-full">
            <thead>
              <tr class="border-b border-slate-200">
                <th class="text-left py-3 px-3 text-xs font-semibold text-slate-600 uppercase tracking-wider">#</th>
                <th class="text-left py-3 px-3 text-xs font-semibold text-slate-600 uppercase tracking-wider">Teacher</th>
                <th class="text-left py-3 px-3 text-xs font-semibold text-slate-600 uppercase tracking-wider">Assigned</th>
                <th class="text-left py-3 px-3 text-xs font-semibold text-slate-600 uppercase tracking-wider">Capacity</th>
                <th class="text-left py-3 px-3 text-xs font-semibold text-slate-600 uppercase tracking-wider">Rate</th>
              </tr>
            </thead>
